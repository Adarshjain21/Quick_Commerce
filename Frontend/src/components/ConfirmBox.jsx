...
const ConfirmBox = ({cancel, confirm, close}) => {
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-50 bg-neutral-800 bg-opacity-70 flex justify-center items-center'>
      <div className='bg-white max-w-md w-full p-4 rounded'>
        <div className='flex justify-between items-center gap-3'>
            ...
            <p className='my-2'>Are you sure permanent delete ?</p>
